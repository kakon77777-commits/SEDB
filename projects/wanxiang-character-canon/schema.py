...
WAVE1_SOURCE_FIELD_SPECS = SOURCE_FIELD_SPECS
WAVE1_SOURCE_OWNED_KEYS = frozenset(
    spec.key for spec in WAVE1_SOURCE_FIELD_SPECS
)
SOURCE_FIELD_SPECS = WAVE1_SOURCE_FIELD_SPECS + CATALOG_SOURCE_FIELD_SPECS
FIELD_SPECS = SOURCE_FIELD_SPECS + CURATED_FIELD_SPECS + PROPOSAL_FIELD_SPECS
SOURCE_OWNED_KEYS = WAVE1_SOURCE_OWNED_KEYS | CATALOG_SOURCE_OWNED_KEYS
...
WAVE1_VIEW_SPECS = VIEW_SPECS
VIEW_SPECS = WAVE1_VIEW_SPECS + CATALOG_VIEW_SPECS
